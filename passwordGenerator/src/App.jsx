    ...
    <>
      ...
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 py-4 text-orange-500 bg-gray-700'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden py-2 px-2 mb-4'>
          <input type="text" value={password} className='outline-none w-full py-3 px-3 rounded' placeholder='password' readOnly/>
          <button className='outline-none rounded bg-blue-700 text-white px-3 py-0.5 shrink-0'>Copy</button>
        </div>
